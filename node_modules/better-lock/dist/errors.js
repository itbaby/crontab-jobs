...
exports.isAcquisitionFailureError = exports.BetterLockJobAbortedError = exports.BetterLockQueueOverflowError = exports.BetterLockExecutionTimeoutError = exports.BetterLockWaitTimeoutError = exports.BetterLockInvalidArgumentError = exports.BetterLockInternalError = exports.BetterLockError = void 0;
...
var BetterLockError = /** @class */ (function (_super) {
    ...
    function BetterLockError(lockName, message, incomingStack) {
        ...
        if (lockName) {
            _this = _super.call(this, "[".concat(lockName, "] ").concat(message)) || this;
        }
        else {
...
var BetterLockInternalError = /** @class */ (function (_super) {
    ...
    function BetterLockInternalError(lockName, message) {
        ...
        return _super.call(this, lockName, message + ' This is probably a bug inside "better-lock" library') || this;
    }
...
var BetterLockInvalidArgumentError = /** @class */ (function (_super) {
    ...
    function BetterLockInvalidArgumentError(lockName, argument, expected, actual) {
        var _this = _super.call(this, lockName, "Argument \"".concat(argument, "\" must be ").concat(expected, " (got: \"").concat(actual, "\")")) || this;
...
var BetterLockWaitTimeoutError = /** @class */ (function (_super) {
    ...
    function BetterLockWaitTimeoutError(lockName, job) {
        var _this = this;
        var message = "".concat(job, " has timed out after ").concat(new Date().valueOf() - job.enqueued_at.valueOf(), "ms in wait queue");
...
var BetterLockExecutionTimeoutError = /** @class */ (function (_super) {
    ...
    function BetterLockExecutionTimeoutError(lockName, job) {
        var _this = this;
        var message = "".concat(job, " has timed out after ").concat(new Date().valueOf() - job.executed_at.valueOf(), "ms of execution");
        _this = _super.call(this, lockName, message, job.incoming_stack) || this;
        _this.job_id = job.id;
        _this.keys = job.keys;
...
var BetterLockQueueOverflowError = /** @class */ (function (_super) {
    ...
    function BetterLockQueueOverflowError(lockName, key, count, job, strategy) {
        var _this = this;
        var keyDesignation = key === internals_1.KeyQueue.DEFAULT_QUEUE_KEY ? '' : " for key \"".concat(key, "\"");
        var message = "Too many jobs (".concat(count, ") are waiting").concat(keyDesignation, ". The ").concat(strategy, " job (").concat(job, ") was kicked out");
        _this = _super.call(this, lockName, message, job.incoming_stack) || this;
        _this.job_id = job.id;
        _this.keys = job.keys;
...
var BetterLockJobAbortedError = /** @class */ (function (_super) {
    ...
    function BetterLockJobAbortedError(lockName, job) {
        var _this = _super.call(this, lockName, "".concat(job, " has been aborted by the user"), job.incoming_stack) || this;
        _this.job_id = job.id;
        _this.keys = job.keys;
        return _this;
    }
...
function isAcquisitionFailureError(err) {
    return ((err && err instanceof BetterLockQueueOverflowError) ||
        err instanceof BetterLockWaitTimeoutError ||
        err instanceof BetterLockJobAbortedError);
}
exports.isAcquisitionFailureError = isAcquisitionFailureError;
