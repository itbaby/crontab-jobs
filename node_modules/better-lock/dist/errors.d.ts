...
export declare class BetterLockQueueOverflowError extends BetterLockError {
    ...
    strategy: IQueueEjectionStrategy;
    constructor(lockName: any, key: any, count: any, job: LockJob<any>, strategy: IQueueEjectionStrategy);
}
...
export declare function isAcquisitionFailureError(err: any): boolean;
